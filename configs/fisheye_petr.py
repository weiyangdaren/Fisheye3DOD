...
custom_imports = dict(
    imports=['projects.Fisheye3DOD.utils',
             ...
             'projects.Fisheye3DOD.models.petr',],
...
cam_fov = 220
train_ann_file = 'ImageSets-2hz/fisheye3dod_infos_train.pkl'
val_ann_file = 'ImageSets-2hz/fisheye3dod_infos_val.pkl'
backend_args = None
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        normedlinear=False,
        ocam_fov=cam_fov,
        ocam_path='data/Fisheye3DOD/calib_results.txt',
        feature_size=(25, 100),
        dbound=(0.5, 48.5, 0.5),
